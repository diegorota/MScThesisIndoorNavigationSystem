...
//            } else {
//                let nodeView = UIView(frame: CGRect(x: node.position.x-3.5, y: node.position.y-3.5, width: 7, height: 7))
//                let nodeImage = UIImageView()
//                nodeImage.image = UIImage(named: "nodo")?.withRenderingMode(.alwaysTemplate)
//                nodeImage.tintColor = UIColor.orange
//                nodeView.addSubview(nodeImage)
//                nodeImage.frame = CGRect(x:0,y:0,width:7,height:7)
//                imageView.addSubview(nodeView)
//            }
//        }
...
//        }
    ...
    func stopNavigation() {
        ...
        bestGraph = nil
        navigationView.labelDirection.text = "START NAVIGATION"
        self.imageView.image = originalImage
        flagView?.isHidden = true
    }
