...
class MedicalExaminationSectionData {
    ...
    static func parse(json: JSON) {
        for examination in json.arrayValue {
            let examinationDetail = ExaminationDetail(name: examination["name"].stringValue, date: examination["date"].stringValue, hour: examination["hour"].stringValue, examinationDescription: examination["examinationDescription"].stringValue, doctor: examination["doctor"].stringValue, POI_ID: examination["POI_ID"].stringValue, beacon_ID: examination["beacon_ID"].stringValue)
